...
_LINKED_FLAGS: dict[str, str] = {
    ...
    "mouse_move": "physical_input",
    "mouse_scroll": "physical_input",
    "keyboard_type": "physical_input",
    "key_press": "physical_input",
...
_CAPABILITY_LINKED_FLAGS: dict[str, str] = {
    ...
    "keyboard.press": "physical_input",
    "mouse.click": "physical_input",
    "mouse.drag": "physical_input",
    "mouse.move": "physical_input",
    "mouse.scroll": "physical_input",
    "mouse.position": "physical_input",
    ...
    "file.list": "file_write",
    "file.search": "file_write",
    "file.mkdir": "file_write",
    "file.move": "file_write",
